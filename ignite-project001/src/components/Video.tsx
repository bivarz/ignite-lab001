        ...
        <div className="flex items-start gap-16">
          <div className="flex-1">
            ...
            <div className='flex items-center gap-4 mt-6'>
              ...
              src="https://github.com/bivarz.png" 
              alt="profile" />
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href='#' className='p-4 text-sm flex items-center rounded font-bold uppercase gap-2 justify-center border border-blue-500 text-blue-500  hover:bg-blue-500 transition-colors hover:text-gray-900'>
             <Lightning size={24}/>
              Acesse o desafio
            </a>
          </div>
